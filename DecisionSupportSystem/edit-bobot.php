...
$query = mysqli_query($koneksi,"SELECT * FROM bobot WHERE id_bobot=".$id);
...
<div class="container">
	...
	<form method="POST" action="">
	  <div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="id" name="id" value="<?php echo $getRow['id_bobot'] ?>" disabled>
	    </div>
	  </div>
	  <div class="form-group row">
	    <label for="kt" class="col-sm-2 col-form-label">Id Kriteria</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="kt" name="kt" value="<?php echo $getRow['id_kriteria'] ?>">
	    </div>
	  </div>
	  <div class="form-group row">
	    <label for="jum" class="col-sm-2 col-form-label">Value</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="jum" name="jm" value="<?php echo $getRow['value'] ?>">
	    </div>
	  </div>
	  <div class="form-group row">
	    <div class="col-sm-10">
