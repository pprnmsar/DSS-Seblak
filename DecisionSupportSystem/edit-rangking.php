...
<div class="container">
	...
	<form method="POST" action="">
	  <div class="form-group">
	    ...
	    <div>
	      <input type="text" class="form-control" id="alt" name="alt" value="<?php echo $getRowalt['nm_alternatif'] ?>" disabled>
	    </div>
	  </div>
	  <div class="form-group">
	    <label for="kr">Kriteria</label>
	    <div>
	      <input type="text" class="form-control" id="kr" name="kr" value="<?php echo $getRowkr['nm_kriteria'] ?>" disabled>
	    </div>
	  </div>
	  <div class="form-group">
